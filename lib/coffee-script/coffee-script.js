...
(function() {
  ...
  exports.compile = compile = function(code, options) {
    var from, head, header, i, js, last, line, lines, match, merge, parsing, vars, _i, _len;
    if (options == null) {
      options = {};
    }
    ...
    */
    ...
    try {
      ...
      for (i = _i = 0, _len = lines.length; _i < _len; i = ++_i) {
        ...
        if (!parsing && line.indexOf('from') !== 0 && line.indexOf('import') !== 0) {
          break;
        }
        parsing = true;
      ...
      err.message = "Error parsing imports (from ... import ...) ";
      if (options.filename) {
        err.message += "in " + options.filename;
      }
      throw err;
    }
    /* END FROM/IMPORT
